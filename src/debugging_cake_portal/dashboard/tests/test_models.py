...
class TestAnalysis:
    ...
    def test_validation_OK(self, nr_users, nr_comments, nr_posts, nr_roles):
        """
    ...
    def test_validation_KO(self, nr_users, nr_comments, nr_posts, nr_roles):
        """
    ...
    def test_validation2_KO(self, nr_users, nr_comments, nr_posts, nr_roles):
        """
